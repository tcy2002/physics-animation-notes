...
可能会有疑问：为什么似乎前面的推导过程没体现牛顿-欧拉方程里的进动项$\omega\times I\omega$？因为产生进动项的本质原因是惯性张量$I$在随时间变化，所以对角动量微分$d(I\omega)$时展开产生了进动项，而上面求的是瞬时冲量，目的是在一瞬间内修正速度，因此将$I$视为常量。也正因为如此，游戏引擎一般无法精确模拟陀螺现象，当角速度非常大时，求解结果或有比较大误差。
