...
需要求的是各个质点的速度变化量 $x=[\Delta v_1^T,\Delta v_2^T,...,\Delta v_n^T]^T$ ，等式左侧 $\Delta v_a$ 的系数整理到矩阵 $A$ 的 $(a,a)$ 处， $\Delta v_b$ 的系数整理到矩阵 $A$ 的 $(a,b)$ 处，等式右侧整理到 $b$ 中的 $(a)$ 处。另外11个相邻质点 $b_n$ 的 $\Delta v_a$ 系数和 $\Delta v_{b_n}$ 系数分别整理到 $(a,a)$ 和 $(a,b_n)$ 处，注意矩阵 $A$ 对角线 $(a,a)$ 处和 $b$ 在 $(a)$ 处的值需要累加，非对角线处的值不需要累加。
